...
app = modal.App("viral-post-inference-v7")
...
# Volumes
checkpoint_vol = modal.Volume.from_name("viral-checkpoints-v7", create_if_missing=False)
...
def generate_post(platform: str = "twitter", hook_type: str = "question",
    ...
    """Generate a viral post using the v7 fine-tuned model."""
    from unsloth import FastLanguageModel
    import torch

    print("🔄 Loading model from v7 checkpoint...")

    model, tokenizer = FastLanguageModel.from_pretrained(
        model_name="/checkpoints/final_v7",
        max_seq_length=2048,
        dtype=None,
        load_in_4bit=True,
    )
