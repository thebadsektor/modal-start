...
app = modal.App("viral-post-finetuner-v6")
...
checkpoint_vol = modal.Volume.from_name("viral-checkpoints-v6", create_if_missing=True)
...
def finetune(config: TrainingConfig):
    ...
    training_args = TrainingArguments(
        output_dir="/checkpoints/final_v6",
    ...
    model.save_pretrained("/checkpoints/final_v6")
    tokenizer.save_pretrained("/checkpoints/final_v6")
